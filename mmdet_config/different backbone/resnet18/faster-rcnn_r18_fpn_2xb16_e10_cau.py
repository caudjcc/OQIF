...
log_level = 'INFO'
load_from = '/HOME/scw6493/run/mmdet/work_dirs/faster-rcnn_r18_fpn_2xb16_e10_cau/epoch_10.pth'
resume = False
launcher = 'none'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/HOME/scw6493/run/models_pre_trained/resnet18.pth')),
    neck=dict(
        type='FPN',
        in_channels=[
            64,
...
visualizer = dict(
    ...
    name='visualizer')
work_dir = '/HOME/scw6493/run/mmdet/test_dirs/backbone/resnet18'
