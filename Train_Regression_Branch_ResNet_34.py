...
# train
network = models.resnet34(weights=False)
network.conv1 = nn.Conv2d(125, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
network.fc = nn.Sequential(nn.Linear(512,1),nn.Sigmoid())
network.to(device)
...
# 训练网络
path_save = '../models_reg/models_34_{}/'.format(NOWTIME[4:8])
num_epochs = 10
